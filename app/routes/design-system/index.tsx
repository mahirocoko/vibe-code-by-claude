    ...
    <div className="space-y-12">
      ...
      <section className="space-y-4">
        ...
        <p className="text-xl text-muted-foreground max-w-3xl">
          ...
          Features a modern color system using oklch color space and fully accessible components.
        </p>
      </section>
      ...
      <section className="grid gap-6 md:grid-cols-2">
        <div className="group relative rounded-xl border p-6 hover:border-primary transition-colors">
          ...
          <p className="text-muted-foreground mb-4">
            Design tokens, color system, typography, and spacing guidelines.
          </p>
        ...
        <div className="group relative rounded-xl border p-6 hover:border-primary transition-colors">
          ...
          <p className="text-muted-foreground mb-4">
            Pre-built UI components with multiple variants and states.
          </p>
          <div className="space-y-2">
      ...
      <section className="space-y-4">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="rounded-lg border p-4">
            ...
            <p className="text-sm text-muted-foreground">
              Built-in dark mode support with automatic theme detection
            </p>
          </div>
          ...
          <div className="rounded-lg border p-4">
            ...
            <p className="text-sm text-muted-foreground">
              Info, warning, success, and error states for better UX
            </p>
          </div>
      ...
      <section className="space-y-4">
        ...
        <div className="prose prose-gray max-w-none">
          <ol className="space-y-2">
            ...
            <li>Components are located in <code>app/components/ui</code></li>
            <li>Use <code>npx shadcn@latest add [component]</code> to add new components</li>
            <li>Customize theme colors in <code>app/styles/globals.css</code></li>
          </ol>
        </div>
      </section>
    </div>
